  ...
  <div class="flex-1 flex flex-col bg-gray-900">
    ...
    <div class="flex-1 overflow-y-auto p-6 space-y-6" ref="messagesContainer">
      ...
      <div v-if="chatMessages.length === 0" class="text-center py-12">
        ...
        <h3 class="text-lg font-medium text-white mb-2">开始您的 AI 演示创作</h3>
        <p class="text-gray-400 mb-6">告诉我您想要创建什么样的演示文稿，我会帮您生成专业的幻灯片</p>
        ...
        <div class="grid grid-cols-2 gap-4 max-w-2xl mx-auto">
          <div 
            ...
            class="template-card text-left group"
            @click="inputText = suggestion.prompt"
          >
            <div class="flex items-start space-x-3">
              <div class="w-10 h-10 bg-blue-600 rounded-lg flex items-center justify-center flex-shrink-0">
                <component :is="suggestion.icon" class="w-5 h-5 text-white" />
              </div>
              <div>
                <h4 class="font-medium text-white mb-1">{{ suggestion.title }}</h4>
      ...
      <!-- 加载状态 -->
      <div v-if="isGenerating" class="flex items-start space-x-3 animate-pulse">
...
const { chatMessages, isGenerating } = storeToRefs(slidesStore)
...
const savePresentation = () => {
  ...
  slidesStore.addChatMessage('ai', '演示文稿已自动保存到本地')
}
